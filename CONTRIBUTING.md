...
- [Making an issue](https://help.github.com/articles/creating-an-issue/). A well described issue helps a lot. (Have a look at the [known issues](https://github.com/search?q=user%3Aadfinis+is%3Aissue+state%3Aopen).)
...
When you spot an issue, [create an issue](https://github.com/adfinis/ansible-role-bareos_dir/issues).

Making the issue help me and others to find similar problems in the future.

### [2. Fork the project.](#2-fork-the-project)

On the top right side of [the repository on GitHub](https://github.com/adfinis/ansible-role-bareos_dir), click `fork`. This copies everything to your GitHub namespace.
